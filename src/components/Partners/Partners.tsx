...
import brand2 from "../../assets/Product/Brand/br-2.png";
import brand3 from "../../assets/Product/Brand/br-3.png";
import brand4 from "../../assets/Product/Brand/br-4.png";
import brand5 from "../../assets/Product/Brand/br-5.png"
;
const Partners = () => {
  return (
