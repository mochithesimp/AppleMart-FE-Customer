...
interface NavbarForPProps {
  handleOrderPopup: () => void;
}
const NavbarforP: React.FC<NavbarForPProps> = ({ handleOrderPopup }) => {
  return (
              ...
              <ul className="flex items-center gap-4">
                {
                  MenuLinks.map((data, index) => (
                    <li key={index}>
                      <a href={data.link} className="inline-block px-4 font-semibold text-gray-500 hover:text-black dark:hover:text-white duration-200 p-2 hover:bg-red-400 w-full p-2 font-semibold">{data.name} </a>
                    </li>
